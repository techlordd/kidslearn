/**
 * Raw maths content — Reception, Year 1 and (now) Year 2.
 *
 ...
 * addition2 / subtraction2 / timesTable) instead of from a word list — see
 * lib/maths.js.
 */
...
export const MATHS_TRAILS = [
  ...
  },
  {
    ...
    blurb: 'Addition and subtraction, from within 10 up to 100.',
    emoji: '➕',
    color: 'sky',
  },
  {
  ...
  {
    id: 'times-tables-town',
    name: 'Times Tables Town',
    blurb: 'Multiplication facts for the 2, 5 and 10 times tables.',
    emoji: '✖️',
    color: 'grape',
  },
];
...
export const MATHS_TOPICS = [
  ...
  },
  {
    ...
    intro: "We're learning to add two-digit numbers together, with answers up to 100.",
    chant: 'Tens and ones, add them with care — two-digit sums, we’ll get there!',
  },
  {
    id: 'subtraction-to-100',
    subject: 'numbers',
    trail: 'adding-taking-away',
    grade: 'year2',
    type: 'subtraction2',
    ...
    intro: "We're learning to take away two-digit numbers, staying under 100.",
    chant: 'Tens and ones, take some away — subtraction sums every day!',
  },
  {
    id: 'times-tables-2-5-10',
    subject: 'numbers',
    trail: 'times-tables-town',
    grade: 'year2',
    type: 'timesTable',
    display: '×',
    name: 'Times Tables: 2, 5, 10',
    intro: "We're learning our 2, 5 and 10 times tables.",
    chant: '2, 4, 6, 8, 10 — count in 2s again! 5, 10, 15, 20 — counting in 5s is plenty!',
    tables: [2, 5, 10],
  },
];
